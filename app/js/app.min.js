...
"use strict";!function(){var s=function(){var s=$(".fullScreen"),e=$(window).height();s.css("height",e+"px")};s();var e=window.innerWidth;$(window).scroll(function(){var s=$(this).scrollTop();if(s>$(".slide4-1").offset().top-100?$(".slide4-1").addClass("fade-in"):$(".slide4-1").removeClass("fade-in"),s>$(".slide4-2").offset().top?$(".slide4-2").addClass("fade-in"):$(".slide4-2").removeClass("fade-in"),s>$(".slide6").offset().top?$(".slide6-1").addClass("fade-in"):$(".slide6-1").removeClass("fade-in"),s>$(".slide6-1").offset().top+50?$(".slide6-2").addClass("fade-in"):$(".slide6-2").removeClass("fade-in"),s>$(".slide6-3").offset().top-200?($(".slide6-3-left").addClass("slide-left"),$(".slide6-3-left").addClass("zIndex"),$(".slide6-3-right").addClass("slide-right"),$(".slide6-3-right").addClass("zIndex")):($(".slide6-3-left").removeClass("slide-left"),$(".slide6-3-right").removeClass("slide-right")),s>$(".slide7").offset().top&&($(".slide6-3-left").removeClass("slide-left"),$(".slide6-3-left").removeClass("zIndex"),$(".slide6-3-right").removeClass("slide-right"),$(".slide6-3-right").removeClass("zIndex")),s>$(".slide8").offset().top+200?($(".slide8-1").addClass("fade-in"),$(".slide8").addClass("bg-slide8")):($(".slide8-1").removeClass("fade-in"),$(".slide8").removeClass("bg-slide8")),s>$(".slide7").offset().top?$(".slide8").addClass("zIndex"):$(".slide8").removeClass("zIndex"),s>$(".slide9").offset().top&&$(".slide8").removeClass("zIndex"),s>$(".slide10").offset().top?$(".slide10-dual").addClass("zIndex"):$(".slide10-dual").removeClass("zIndex"),s>$(".slide10-fin").offset().top&&$(".slide10-dual").removeClass("zIndex"),e>=720){var d=$("#punto").height(),l=144+d;s>$(".slide10-fin").offset().top?$(".slide11").addClass("zIndex"):$(".slide11").removeClass("zIndex"),s>$(".slide11").offset().top+115?$(".slide11-principal").addClass("stiky"):$(".slide11-principal").removeClass("stiky"),s>$(".slide11").offset().top+$(window).height()/1.58?($(".slide11-txt-1").addClass("stiky2"),$(".slide11-txt-1").css("top",l)):($(".slide11-txt-1").removeClass("stiky2"),$(".slide11-txt-1").css("top",0)),s>$(".slide11").offset().top+$(window).height()/.94?($(".slide11-txt-2").addClass("stiky2"),$(".slide11-txt-2").css("top",l)):($(".slide11-txt-2").removeClass("stiky2"),$(".slide11-txt-2").css("top",0)),s>$(".slide11").offset().top+$(window).height()/.665?($(".slide11-txt-3").addClass("stiky2"),$(".slide11-txt-3").css("top",l)):($(".slide11-txt-3").removeClass("stiky2"),$(".slide11-txt-3").css("top",0))}})}();